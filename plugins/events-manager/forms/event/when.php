...
<div class="event-form-when" id="em-form-when">
	<p class="em-date-range">
		...
		<input class="em-date-end em-date-input-loc" type="hidden" />
		<input class="em-date-input" type="hidden" name="event_end_date" value="<?php echo $EM_Event->end()->getDate();; ?>" />
	</p>
	<h3 class="horario-consulta-title">Horario de la consulta</h3>
	...
	<!-- < ?php esc_html_e( 'lorem umpsum', 'events-manager'); ?> -->
	</span>
</div>  
