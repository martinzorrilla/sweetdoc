<?php get_header();/* Template Name: Create Eco Arterial*/?>
<?php 
  ...
  $eco_arterial_patient_array = sw_get_eco_arterial_id($app_id);
  $eco_arterial_post_id = isset($eco_arterial_patient_array[0]) ? $eco_arterial_patient_array[0] : NULL;
  ...
  $title = $eco_arterial_post_id === NULL ? "Crear informe de ecografía" : "Editar informe de ecografía";
...
<div class="callout secondary">
  ...
  <div class="tab">
    <button class="tablinks dabbed tab-eco-arterial" data-id="izquierdo"  id="defaultOpen">Izquierdo</button>
    <button class="tablinks dabbed tab-eco-arterial" data-id="derecho">Derecho</button>
  </div>

  <form id="create-eco-arterial-form" name="create-eco-arterial-form" method="post">
    <?php 
    hm_get_template_part('template-parts/eco-arterial/eco-arterial-data', ['patient_id' => $patient_id, 'app_id' => $app_id, 'eco_arterial_post_id' => $eco_arterial_post_id, 'is_editable' => $is_editable ]); 

    hm_get_template_part('template-parts/eco-arterial/eco-arterial-data-derecho', ['patient_id' => $patient_id, 'app_id' => $app_id, 'eco_arterial_post_id' => $eco_arterial_post_id, 'is_editable' => $is_editable ]); 
    ?>
  </form>
...
<div class="row" style="padding-top: 2rem;">  
    <div class="small-12 columns text-center" style="padding-bottom:1em;">
      <a id="create-eco-arterial" href="#" class="crete-app btn btn-green botones-estandard">Guardar</a>
    </div>
</div>
